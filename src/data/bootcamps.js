...
export const bootcamps = [
  {
    id: 'ai-engineer',
    title: 'AI Engineer (Agentic AI & LLM Mastery)',
    duration: '20 Weeks',
    schedule: 'Full-time',
    price: 15999,
    description: 'Master the cutting-edge world of AI agents and large language models. Build autonomous AI systems, fine-tune LLMs, and create intelligent applications that think and act.',
    icon: {
    ...
    curriculum: [
      ...
      'Building AI agents with LangChain and AutoGPT',
